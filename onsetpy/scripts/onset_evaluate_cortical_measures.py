...
def main():
    ...
    roi_mapping = {  # Dictionary mapping FreeSurfer ROIs to full anatomical names
        ...
        "G_and_S_cingul-Mid-Ant": "Middle-anterior part of the<br>cingulate gyrus and sulcus (aMCC)",
        "G_and_S_cingul-Mid-Post": "Middle-posterior part of the<br>cingulate gyrus and sulcus (pMCC)",
        "G_cingul-Post-dorsal": "Posterior-dorsal part of the cingulate gyrus (dPCC)",
        "G_cingul-Post-ventral": "Posterior-ventral part of the<br>cingulate gyrus (vPCC, isthmus of the cingulate gyrus)",
        "G_cuneus": "Cuneus (O6)",
        ...
        "G_oc-temp_med-Lingual": "Lingual gyrus, ligual part of the<br>medial occipito-temporal gyrus, (O5)",
        "G_oc-temp_med-Parahip": "Parahippocampal gyrus, parahippocampal<br>part of the medial occipito-temporal gyrus, (T5)",
        ...
        "G_temp_sup-Plan_tempo": "Planum temporale or temporal plane of<br>the superior temporal gyrus",
        "G_temporal_inf": "Inferior temporal gyrus (T3)",
        "G_temporal_middle": "Middle temporal gyrus (T2)",
        "Lat_Fis-ant-Horizont": "Horizontal ramus of the anterior segment of<br>the lateral sulcus (or fissure)",
        "Lat_Fis-ant-Vertical": "Vertical ramus of the anterior segment of the<br>lateral sulcus (or fissure)",
        ...
        "S_intrapariet_and_P_trans": "Intraparietal sulcus (interparietal sulcus)<br>and transverse parietal sulci",
        "S_oc_middle_and_Lunatus": "Middle occipital sulcus and lunatus sulcus",
        "S_oc_sup_and_transversal": "Superior occipital sulcus and transverse<br>occipital sulcus",
        "S_occipital_ant": "Anterior occipital sulcus and preoccipital notch<br>(temporo-occipital incisure)",
        "S_oc-temp_lat": "Lateral occipito-temporal sulcus",
        "S_oc-temp_med_and_Lingual": "Medial occipito-temporal sulcus (collateral sulcus)<br>and lingual sulcus",
